"use strict";
// Question 17
const MoreInvitesDinner = ["aisha", "alishba", "areeba"];
...
// Question 18
const countryVisit = ["Suadia", "Dubai", "Oman", "Kuwait", "Uk"];
...
console.log("Reverse alphabetical order:", ...countryVisit.sort().reverse());
// Question 19
const SameMoreInvitesDinner = ["aisha", "alishba", "areeba"];
console.log("Unfortunately, the new dinner table won't arrive in time, and we can only invite two people for dinner.");
MoreInvitesDinner.unshift("kinza", "sarah");
...
const apple = { name: "Apple", color: "Red", taste: "Sweet and crisp" };
const banana = { name: "Banana", color: "Yellow", taste: "Sweet and creamy" };
const orange = { name: "Orange", color: "Orange", taste: "Tangy and refreshing" };
...
// Question 30
const users = ["Aamir", "Ahmed", "haider", "admin", "ashir"];
